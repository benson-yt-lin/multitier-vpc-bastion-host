...
locals {
  ...
  baserules = [
    ["allow", "169.45.235.176/28", "0.0.0.0/0", "inbound", "tcp", 80, 80, 1024, 65535],
    ["allow", "150.238.230.128/27", "0.0.0.0/0", "inbound", "tcp", 80, 80, 1024, 65535],
    ["allow", "169.45.235.176/28", "0.0.0.0/0", "inbound", "udp", 53, 53, 1024, 65535],
    ["allow", "150.238.230.128/27", "0.0.0.0/0", "inbound", "udp", 53, 53, 1024, 65535],
    ["allow", "0.0.0.0/0", "169.45.235.176/28", "outbound", "tcp", 1024, 65535, 80, 80],
    ["allow", "0.0.0.0/0", "150.238.230.128/27", "outbound", "tcp", 1024, 65535, 80, 80],
    ["allow", "0.0.0.0/0", "169.45.235.176/28", "outbound", "udp", 1024, 65535, 53, 53],
    ["allow", "0.0.0.0/0", "150.238.230.128/27", "outbound", "udp", 1024, 65535, 53, 53],
